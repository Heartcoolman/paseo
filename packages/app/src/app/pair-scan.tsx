  ...
  const handleScan = useCallback(
    async (result: BarcodeScanningResult) => {
      ...
      try {
        ...
        const message = error instanceof Error ? error.message : t("pairing.scan.unablePair");
        Alert.alert(t("pairing.scan.errorTitle"), message);
      } finally {
        setIsPairing(false);
      }
    },
    [isPairing, navigateToPairedHost, upsertDaemonFromOfferUrl, t],
  );
      ...
      <View style={styles.container}>
        ...
        <View style={bodyStyle}>
          <View style={styles.permissionCard}>
            <Text style={styles.permissionTitle}>{t("pairing.scan.notAvailableWeb")}</Text>
            <Text style={styles.permissionBody}>{t("pairing.scan.notAvailableWebBody")}</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={bodyStyle}>
        {!granted ? (
          <View style={styles.permissionCard}>
            <Text style={styles.permissionTitle}>{t("pairing.scan.cameraPermission")}</Text>
