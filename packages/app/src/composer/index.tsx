...
function resolveMessagePlaceholder(isDesktopWebBreakpoint: boolean): string {
  return isDesktopWebBreakpoint
    ? i18n.t("composer.input.desktopPlaceholder")
    : i18n.t("composer.input.mobilePlaceholder");
}
    ...
    <View style={styles.queueItem}>
      ...
      <View style={styles.queueActions}>
        <Pressable
          ...
          accessibilityLabel={t("composer.queue.editQueuedMessage")}
        ...
        <Pressable
          ...
          accessibilityLabel={t("composer.queue.sendQueuedMessageNow")}
          accessibilityRole="button"
        >
...
function ImageAttachmentPill({
  ...
  return (
    <AttachmentPill
      ...
      openAccessibilityLabel={t("composer.attachment.openImage")}
      removeAccessibilityLabel={t("composer.attachment.removeImage")}
      disabled={disabled}
    >
...
function GithubAttachmentPill({
  ...
  const kindLabel = item.kind === "pr" ? "PR" : t("composer.github.kindIssue");
  const handleOpen = useCallback(() => {
    onOpen(attachment);
  }, [onOpen, attachment]);
  const handleRemove = useCallback(() => {
  ...
  return (
    <AttachmentPill
      ...
      onOpen={handleOpen}
      onRemove={handleRemove}
      openAccessibilityLabel={t("composer.github.openItem", {
        kind: kindLabel,
        number: item.number,
      })}
      removeAccessibilityLabel={t("composer.github.removeItem", {
        kind: kindLabel,
        number: item.number,
      })}
      disabled={disabled}
...
export function Composer({
  ...
  const attachmentMenuItems = useMemo<AttachmentMenuItem[]>(
    () => [
      {
        id: "image",
        label: t("composer.menu.addImage"),
      ...
      {
        id: "github",
        label: t("composer.menu.addIssueOrPr"),
        ...
        <View style={styles.inputAreaContent}>
          ...
          <View ref={messageInputContainerRef} style={styles.messageInputContainer}>
            ...
            <Combobox
              ...
              title={t("composer.github.attachIssueOrPr")}
