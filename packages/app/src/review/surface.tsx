...
export function InlineReviewGutterCell({
  ...
  return (
    <Pressable
      ...
      accessibilityLabel={canComment ? t("git.review.addComment") : undefined}
    ...
    <View style={styles.commentBlock}>
      ...
      <View style={styles.commentActions}>
        <Pressable
          ...
          accessibilityLabel={t("git.review.editComment")}
        ...
        <Pressable
          accessibilityRole="button"
          accessibilityLabel={t("git.review.deleteComment")}
...
export function InlineReviewEditor({
  ...
  return (
    <View style={styles.editorBlock} testID={testID}>
      <TextInput
        ref={inputRef}
        accessibilityLabel={t("git.review.commentLabel")}
        testID={testID ? `${testID}-input` : undefined}
        placeholder={t("git.review.commentPlaceholder")}
      ...
      <View style={styles.editorActions}>
        <Button
          accessibilityLabel={t("git.review.cancelComment")}
        ...
        <Button
          accessibilityLabel={t("git.review.saveComment")}
