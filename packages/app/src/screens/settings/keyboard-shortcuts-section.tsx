        ...
        {bindingId !== null && (
          <>
            ...
            <Button variant="ghost" size="sm" onPress={isCapturing ? onCancel : onRebind}>
              {isCapturing ? t("common.action.cancel") : t("settings.shortcuts.rebind")}
            </Button>
          </>
        )}
...
export function KeyboardShortcutsSection() {
  ...
  if (isNative) {
    return (
      <SettingsSection title={t("settings.sidebar.shortcuts")}>
        <View style={mobileCardStyle}>
          <Text style={styles.mobileText}>{t("settings.shortcuts.desktopOnly")}</Text>
        </View>
      </SettingsSection>
    );
  }
