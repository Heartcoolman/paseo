...
function RosettaCalloutDescription() {
  ...
  return (
    <>
      <SidebarCalloutDescriptionText>{t("desktop.rosetta.body1")}</SidebarCalloutDescriptionText>
      <SidebarCalloutDescriptionText>{t("desktop.rosetta.body2")}</SidebarCalloutDescriptionText>
    </>
  );
}
