  ...
  if (!showActiveState) {
    return (
      <Pressable
        ...
        accessibilityLabel={t("common.dictation.start")}
    ...
    <View style={styles.activeContainer}>
      ...
      <View style={styles.actionGroup}>
        <Pressable
          ...
          accessibilityLabel={t("common.dictation.cancel")}
        ...
        {!actionsDisabled && isFailed ? (
          <Pressable
            onPress={onRetry}
            accessibilityLabel={t("common.dictation.retry")}
        ...
        {!actionsDisabled && !isFailed ? (
          <>
            <Pressable
              onPress={onAccept}
              accessibilityLabel={t("common.dictation.insert")}
            ...
            <Pressable
              ...
              accessibilityLabel={t("common.dictation.insertAndSend")}
              style={ACTION_CONFIRM_STYLE}
            >
      ...
      <View style={overlayStyles.centerContainer}>
        ...
        {isFailed ? (
          <Text numberOfLines={2} style={overlayTranscriptTextStyle}>
            {errorText
              ? t("common.dictation.failedWithError", { error: errorText })
              : t("common.dictation.failedTapRetry")}
          </Text>
        ) : null}
      </View>
