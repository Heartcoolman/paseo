    ...
    <Modal transparent animationType="fade" statusBarTranslucent visible onRequestClose={onClose}>
      <View style={styles.root}>
        <Pressable
          ...
          accessibilityLabel={t("common.attachmentLightbox.dismissImage")}
          onPress={onClose}
        ...
        <View style={styles.contentLayer}>
          <View style={styles.imageArea}>
            {hasError ? (
              <Text style={styles.errorText}>{t("common.attachmentLightbox.loadError")}</Text>
            ) : (
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel={t("common.attachmentLightbox.closeImage")}
            hitSlop={8}
            onPress={onClose}
