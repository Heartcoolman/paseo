...
export const LeftSidebar = memo(function LeftSidebar({
  ...
  const activeHostLabel = useMemo(() => {
    if (!activeDaemon) return t("common.sidebar.noHost");
...
function AddProjectTooltipContent({
  ...
  return (
    <View style={styles.tooltipRow}>
      <Text style={styles.tooltipText}>{t("common.sidebar.addProject")}</Text>
    ...
    <View style={styles.sidebarFooter}>
      ...
      <View style={styles.footerIconRow}>
        <Tooltip delayDuration={300}>
          <TooltipTrigger asChild>
            <FooterIconButton
              ...
              accessibilityLabel={t("common.sidebar.addProject")}
              icon={FolderPlus}
              theme={theme}
            />
          </TooltipTrigger>
        ...
        <FooterIconButton
          onPress={handleHome}
          testID="sidebar-home"
          accessibilityLabel={t("common.sidebar.home")}
          icon={Home}
          theme={theme}
        />
        <FooterIconButton
          ...
          accessibilityLabel={t("common.sidebar.settings")}
          icon={Settings}
          theme={theme}
        />
      </View>
      <Combobox
        ...
        searchable={false}
        title={t("common.sidebar.switchHost")}
        searchPlaceholder={t("common.sidebar.searchHosts")}
        desktopMinWidth={280}
        ...
        <Animated.View style={mobileSidebarStyle} pointerEvents="auto">
          <View style={styles.sidebarContent} pointerEvents="auto">
            ...
            <Pressable
              ...
              accessible
              accessibilityRole="button"
              accessibilityLabel={t("common.sidebar.closeSidebar")}
              hitSlop={8}
            >
              {({ hovered, pressed }) => (
                <X
...
function WorkspacesSectionHeader({
  ...
  return (
    <View style={styles.workspacesSectionHeader}>
      <Text style={styles.workspacesSectionTitle}>{t("common.sidebar.workspaces")}</Text>
      <View style={styles.workspacesSectionActions}>
        <Tooltip delayDuration={300}>
          <TooltipTrigger asChild>
            <Pressable
              accessibilityRole="button"
              accessibilityLabel={t("common.sidebar.newWorkspace")}
          ...
          <TooltipContent side="bottom" align="center" offset={8}>
            <HeaderIconTooltipContent label={t("common.sidebar.newWorkspace")} />
          </TooltipContent>
        </Tooltip>
        <Tooltip delayDuration={300}>
          <TooltipTrigger asChild>
            <Pressable
              accessibilityRole="button"
              accessibilityLabel={t("common.sidebar.openCommandCenter")}
        ...
        <Tooltip delayDuration={300}>
          ...
          <TooltipContent side="bottom" align="center" offset={8}>
            <HeaderIconTooltipContent label={t("common.sidebar.displayPreferences")} />
          </TooltipContent>
        </Tooltip>
      </View>
    </View>
