...
export function Combobox({
  ...
  const resolvedPlaceholder = placeholder ?? t("common.combobox.searchPlaceholder");
  const resolvedEmptyText = emptyText ?? t("common.combobox.emptyText");
  const resolvedCustomValuePrefix = customValuePrefix ?? t("common.combobox.customValuePrefix");
  const resolvedTitle = title ?? t("common.combobox.title");
